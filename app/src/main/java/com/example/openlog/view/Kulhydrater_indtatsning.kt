...
import com.example.openlog.databinding.FragmentKulhydraterIndtastningBinding
import com.example.openlog.viewModel.DataViewModel
import com.google.firebase.auth.FirebaseUser

public class Kulhydrater_indtatsning: Fragment() {

    private val dataViewModel: DataViewModel by activityViewModels()
    private lateinit var binding: FragmentKulhydraterIndtastningBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_kulhydrater_indtastning, container, false)
        return binding.root
    }
    ...
    fun onLogInput(){
        ...
        dataViewModel.changeInput("kulhydrater " + binding.textInput.text.toString())
