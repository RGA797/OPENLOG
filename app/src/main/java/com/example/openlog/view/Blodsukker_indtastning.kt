...
class Blodsukker_indtastning: Fragment() {

    private val dataViewModel: DataViewModel by activityViewModels()
    private lateinit var binding: FragmentBlodsukkerIndtastningBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_blodsukker_indtastning, container, false)
        return binding.root
    }
    ...
    fun onLogInput(){
        ...
        dataViewModel.changeInput("blodsukker " + binding.textInput.text.toString())
